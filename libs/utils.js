...
exports.getConfigDir = function () {
	// var configDir = os.homedir() + '/.cd-cluster'; // 系统根目录
	var configDir =  '.cd-cluster'; // 项目路径
	try {
...
exports.isJsonString = function (jsonString){
	if (exports.isNull(jsonString) || jsonString === "") {
		return false;
	}
...
exports.getJsonArr = function (jsonString){
	var json ;
	try {
		json = JSON.parse(jsonString);
	} catch {
		return []; // 解析失败，字符串不是JSON格式
	}
	return  json;
}
exports.getJsonMap = function (jsonString){
	if (exports.isJsonString(jsonString)) {
